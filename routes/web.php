...
Route::prefix('plantio')->group(function () { //considerando que o projeto estará em subdiretório em homol/prod (TODO: testar uso de env('APP_FOLDER', 'ndtic'))
...
Route::get('/sair', function () {
    Auth::logout();
    return redirect('/'.env('APP_FOLDER', 'plantio'));
})->name('sair');
