...
<body>
    ...
    <nav  class="navbar navbar-expand-xl navbar-dark bg-primary mb-5 fixed-top">
        <div class="container-fluid">
            <a class="ndtic-brand navbar-brand mb-0" href="{{ route('start') }}">
            ...
            <div class="d-flex">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/eleicoes/sair" title="Sair do Sistema"><i class="fas fa-sign-out-alt fa-2x" style="color: white;"></i></a>
                    </li>
                    @endauth
                    @guest
                    <li class="nav-item">
                        <a class="nav-link" href="/eleicoes/entrar" title="Entrar do Sistema"><i class="fas fa-sign-in-alt fa-2x" style="color: white;"></i></a>
                    </li>
                    @endguest
                </ul>
            </div>
