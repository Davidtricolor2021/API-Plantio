...
<div class="row containerTabela mt-5">
    ...
    <br>
    No e-mail, informe o serviço a ser solicitado (esqueci a senha/criar usuário), o e-mail caso esteja solicitando o serviço para terceiro, e o sistema (<strong>SIV WEB</strong>)
    </p>
</div>
@endsection
